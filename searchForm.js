...
import { getDataResult2 } from "./api.js";
...
export default class SearchForm {
    ...
    executeSearch() {
        ...
        getDataResult(this.inputSearch.value)
            // .then(searchData => getDataResult2(searchData))
            .then((dataParam, arrayOfImages, arrayOfChanges, arrayOfPrice) => {
                ...
                // this.showList(searchData, arrayOfImages, arrayOfChanges, arrayOfPrice);
            })
        // .then (()=> showList(searchData, arrayOfImages, arrayOfChanges, arrayOfPrice))
